...
const work = [
  ...
  {
    name: 'Bulpros',
    position: 'Specialist in Treatment of Information',
    url: 'https://zenysis.com',
    startDate: '2017-06',
    endDate: '2017-08',
    highlights: [
      'First point of contact, customer service job for Concentrix, for their RentalCars.com account.',
      'My experience was almost exclusively on the phone.',
    ],
  },
];
