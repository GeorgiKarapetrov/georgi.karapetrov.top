...
A mathematician dabbling in physics, systems engineer, and FOSS enthusiast.

# Currently

At SAP I am developing the Secret Management and IAM solutions for the SAP Cloud platform. On a daily basis I design and develop features, squash bugs, craft platform tools, as well as build and maintain CI/CD pipelines.

# Previously

At VMWare I was developing a DBaaS and Data Service Manager, an on-prem database management system. The teams at VMWare are true self-sufficient DevOps teams. We were developers, SRE's, platform engineers and customer support all at once. I like to talk about this one at length.

At Sciant I was spinning cloud infrastructure, CI/CD pipelines, self hosted pipeline runners, a version control system, as well as any other infrastructure and all IT administration tasks that need attention. The DevOps team there grew out of the Sysadmin team and so it still solved the full spectrum of IT tasks, from the mundane user issues or order placements up to infrastructure architecture design, implementation, SRE, HA, security, monitoring and debugging across on-site, hybrid, and cloud native landscapes. We supported Sciant internally and Sciant's customers.
